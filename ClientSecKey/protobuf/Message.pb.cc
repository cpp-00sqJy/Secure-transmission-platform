...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::RequestMsg, seckeyid_),
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Message_2eproto = {
  &descriptor_table_Message_2eproto_initialized, descriptor_table_protodef_Message_2eproto, "Message.proto", 230,
...
const int RequestMsg::kSeckeyidFieldNumber;
...
RequestMsg::RequestMsg(const RequestMsg& from)
  ...
  ::memcpy(&cmdtype_, &from.cmdtype_,
    ...
    reinterpret_cast<char*>(&cmdtype_)) + sizeof(seckeyid_));
...
void RequestMsg::SerializeWithCachedSizes(
  ...
  // int32 seckeyid = 6;
  if (this->seckeyid() != 0) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32(6, this->seckeyid(), output);
  }
...
::PROTOBUF_NAMESPACE_ID::uint8* RequestMsg::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 seckeyid = 6;
  if (this->seckeyid() != 0) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(6, this->seckeyid(), target);
  }
