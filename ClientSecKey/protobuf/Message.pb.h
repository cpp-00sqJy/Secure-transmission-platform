...
class RequestMsg :
 ...
 public:
  ...
  // int32 seckeyid = 6;
  void clear_seckeyid();
  static const int kSeckeyidFieldNumber = 6;
...
// int32 seckeyid = 6;
inline void RequestMsg::clear_seckeyid() {
  seckeyid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 RequestMsg::seckeyid() const {
  // @@protoc_insertion_point(field_get:RequestMsg.seckeyid)
  return seckeyid_;
}
inline void RequestMsg::set_seckeyid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  seckeyid_ = value;
  // @@protoc_insertion_point(field_set:RequestMsg.seckeyid)
}
